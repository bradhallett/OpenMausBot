  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        attach_voice_note: { type: "boolean", description: "True to attach this turn's send_voice_note recording to the post. Call send_voice_note first; without one the post is refused." },
      },
