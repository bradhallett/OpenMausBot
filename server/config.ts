...
export function saveConfig(
  ...
  for (const key of ["xai", "anthropic", "openaiCompat", "decisionModel", "composio", "box", "opencodeGo", "tts", "imageGen", "profile", "rooms", "threads", "context", "localVm", "features", "budgets", "billing", "decisions", "onboarding", "browserEngine"] as const) {
